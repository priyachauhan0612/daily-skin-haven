    ...
    <footer className="bg-gray-50 pt-12 pb-8">
      <div className="container px-4 mx-auto">
        ...
        <div className="max-w-md mx-auto mb-12 text-center">
          ...
          <p className="text-gray-600 mb-6">Sign up to get the latest on sales, new releases and more…</p>
          <div className="flex gap-2">
            <Input placeholder="Your email address" className="rounded-full" />
            <Button className="bg-black hover:bg-gray-800 text-white rounded-full">Subscribe</Button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              ...
              <li><Link to="/shop/bestsellers" className="hover:text-black transition-colors">Best Sellers</Link></li>
              <li><Link to="/shop/new" className="hover:text-black transition-colors">New Arrivals</Link></li>
              <li><Link to="/shop/concern" className="hover:text-black transition-colors">Shop by Concern</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              <li><Link to="/account" className="hover:text-black transition-colors">My Account</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              ...
              <li><Link to="/returns" className="hover:text-black transition-colors">Return Policy</Link></li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t">
          <div className="mb-4 md:mb-0">
            <p className="text-sm text-gray-600">&copy; {new Date().getFullYear()} Glow Naturally. All rights reserved.</p>
          </div>
